              ...
              {invoices.isLoading
                ? Array.from({ length: 8 }).map((_, index) => (
                    <TableRow key={`skeleton-${index}`}>
                      ...
                      <TableCell><Skeleton className="h-5 w-28" aria-hidden /></TableCell>
                      <TableCell><Skeleton className="h-5 w-36" aria-hidden /></TableCell>
                      <TableCell><Skeleton className="h-5 w-24" aria-hidden /></TableCell>
                      <TableCell className="text-right"><Skeleton className="ml-auto h-5 w-24" aria-hidden /></TableCell>
                      <TableCell><Skeleton className="h-6 w-28" aria-hidden /></TableCell>
                      <TableCell><Skeleton className="h-5 w-24" aria-hidden /></TableCell>
                    </TableRow>
                  ))
