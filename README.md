...
- [ ] **Phase 1 — Foundation:** Projekt-Setup, Architektur, CI/CD
...
Python 3.11 · FastAPI · LangGraph · PostgreSQL mit pgvector · Temporal · Azure OpenAI · Docker

---

## Kontakt

Fabian Kipke — [GitHub](https://github.com/fkipke)
